...
const KO = {
  ...
  '已結案': '완료',
  '已關閉': '종료',
  '你已有一則進行中的諮詢，請先完成後再提交新問題。': '이미 진행 중인 질문이 있어요. 완료한 뒤에 새 질문을 제출해 주세요.',
  ...
  '這筆諮詢已付款或狀態已變更。': '이미 결제되었거나 상태가 변경된 질문이에요.',
  '找不到對應的諮詢，請重新提交。': '해당 질문을 찾을 수 없어요. 다시 제출해 주세요.',
  '提交資料不完整，請重試。': '제출 정보가 완전하지 않아요. 다시 시도해 주세요.',
  '前往付款時發生問題，請稍後再試。': '결제 페이지로 이동하는 중 문제가 발생했어요. 잠시 후 다시 시도해 주세요.',
  '每則諮詢僅能追問一次。': '추가 질문은 질문 1건당 한 번만 할 수 있어요.',
  '追問期限已過，諮詢已結案。': '추가 질문 기한이 지나 질문이 완료되었어요.',
  '目前無法追問。': '지금은 추가 질문을 할 수 없어요.',
  '找不到這則諮詢。': '이 질문을 찾을 수 없어요.',
  '請填寫追問內容。': '추가 질문 내용을 입력해 주세요.',
  '送出追問時發生問題，請稍後再試。': '추가 질문을 보내는 중 문제가 발생했어요. 잠시 후 다시 시도해 주세요.',
  '目前無法結案。': '지금은 질문을 종료할 수 없어요.',
  '結案時發生問題，請稍後再試。': '질문 종료 중 문제가 발생했어요. 잠시 후 다시 시도해 주세요.',
  '這則諮詢已回饋過。': '이 질문에는 이미 피드백을 남기셨어요.',
  ...
  '諮詢細節': '질문 상세',
  '即將推出': '출시 예정',
  '單獨問事即將推出': '1:1 맞춤 질문 출시 예정',
  '單獨問事目前尚未開放，即將推出。': '1:1 맞춤 질문은 아직 오픈 전이에요. 곧 선보일 예정이에요.',
  '單獨問事 - FuSang Vision': '1:1 맞춤 질문 - FuSang Vision',
  '單獨問事': '1:1 맞춤 질문',
  '一個真正重要的問題，由真人為你解盤。': '정말 중요한 질문 하나, 사람이 직접 명반을 읽어 드려요.',
  '當你有一個真正重要、想要被慎重對待的問題，單獨問事是為你一個人準備的一次解讀。': '정말 중요하고 신중하게 다뤄지길 바라는 질문이 있을 때, 1:1 맞춤 질문은 오직 당신만을 위해 준비하는 한 번의 해석이에요.',
  '服務特色': '서비스 특징',
  '單次問事費用': '질문 1회 비용',
  ...
  '我是 R.S. Chen，大家都叫我 Ben。我先以一對一的方式為人解讀命盤；之後推出線上的「命財官解析」，至今已有 300 多位使用者。': '저는 R.S. Chen이고, 다들 Ben이라고 불러요. 처음에는 1:1로 명반을 해석해 드렸고, 이후 온라인 ‘명재관 핵심 분석’을 선보여 지금까지 300명이 넘는 분들이 이용해 주셨어요.',
  '自我探索': '자기 탐색',
  '勇氣': '용기',
  '清晰': '명료함',
  '如實': '있는 그대로',
  '查看進行中的諮詢': '진행 중인 질문 보기',
  '提交新的問事': '새 질문 제출',
  '你目前有一則進行中的諮詢。同一時間僅能進行一則。': '현재 진행 중인 질문이 1건 있어요. 질문은 한 번에 1건만 진행할 수 있어요.',
  '提交問事 - FuSang Vision': '질문 제출 - FuSang Vision',
  '尚無命盤': '아직 명반이 없어요',
  '單獨問事需先有你的命盤。請先回到儀表板生成命盤，完成後再回來提交問題。': '1:1 맞춤 질문을 신청하려면 먼저 명반이 필요해요. 대시보드에서 명반을 만든 뒤 다시 돌아와 질문을 제출해 주세요.',
  '前往儀表板 →': '대시보드로 이동 →',
  '你有一筆尚未完成付款的諮詢，已為你載入內容。完成付款後即進入回覆佇列。': '결제가 완료되지 않은 질문이 있어 내용을 불러왔어요. 결제를 마치면 바로 답변 대기열에 들어가요.',
  '選擇主題': '주제 선택',
  '描述你的處境': '상황 설명',
  ...
  '尚需：': '남은 항목: ',
  '、': ', ',
  '我的問事紀錄 - FuSang Vision': '내 질문 기록 - FuSang Vision',
  '可回饋': '피드백 가능',
  '尚無紀錄': '기록 없음',
  '你還沒有任何問事紀錄。': '아직 질문 기록이 없어요.',
  '提交第一則問事 →': '첫 질문 제출하기 →',
  '諮詢細節 - FuSang Vision': '질문 상세 - FuSang Vision',
  '找不到諮詢': '질문을 찾을 수 없어요',
  '找不到這則諮詢，或它不屬於你的帳號。': '이 질문을 찾을 수 없거나 내 계정의 질문이 아니에요.',
  '返回我的問事紀錄 →': '내 질문 기록으로 돌아가기 →',
  '編號': '번호',
  '你的問題': '내 질문',
  '提交於': '제출일',
  ...
  '回覆於': '답변일',
  '你的追問': '내 추가 질문',
  '已送出追問，等待再次回覆。回覆完成後本諮詢即結案。': '추가 질문이 접수되었어요. 답변을 기다려 주세요. 답변이 완료되면 이 질문은 종료돼요.',
  '再次回覆': '추가 질문 답변',
  '追問一次': '추가 질문 (1회)',
  '寫下你的追問…': '추가 질문을 적어 주세요…',
  '送出追問': '추가 질문 보내기',
  '我沒有其他問題了，結束諮詢': '더 궁금한 점이 없어요. 질문 종료하기',
  '諮詢已關閉': '질문이 종료되었어요',
  '關閉於': '종료일',
  '你的回饋': '내 피드백',
  '結案後將無法再追問，且此諮詢會結束。確定要結束嗎？': '종료하면 더 이상 추가 질문을 할 수 없고, 이 질문은 마무리돼요. 정말 종료할까요?',
  '確定結案': '종료하기',
  '取消': '취소',
  ...
  '為你個別撰寫': '당신만을 위해 작성',
  '每一則諮詢都是針對你的問題單獨準備。我們拒絕罐頭答案，每一字一句皆是基於你的能量流動所寫下。': '모든 답변은 당신의 질문만을 위해 따로 준비해요. 틀에 박힌 답변은 드리지 않아요. 한 글자 한 문장, 당신의 에너지 흐름을 바탕으로 적어 내려가요.',
  '可追問一次': '추가 질문 1회',
  ...
  '一對一解讀命盤': '1:1 명반 해석',
  '位使用者用過線上命財官解析': '명이 온라인 명재관 핵심 분석을 이용했어요',
};
...
export function disclaimerHtml() {
  ...
  if (L === 'ko') {
    return `<div class="disclaim"><div class="disclaim-h">제출 전에 확인해 주세요</div><ul>` +
      `<li>사람이 직접 명반을 풀어 드리는 개인 맞춤 자미두수 질문 서비스예요. 배경을 자세히 적어 주실수록 답변이 더 정확해져요.</li>` +
      `<li>답변은 설정하신 리포트 언어(繁體中文／简体中文／English／日本語／한국어)로, 리포트 내용에 맞춰 작성해 드려요.</li>` +
      `<li><strong>질문은 한 번에 1건만 진행할 수 있어요.</strong> 현재 질문이 종료된 뒤에 새 질문을 제출할 수 있어요.</li>` +
      `<li>결제 후 <strong>7일 이내</strong>에 서면 답변을 받아요. 답변 후 <strong>7일 이내에 추가 질문 1회</strong>가 가능하며, 기한이 지나면 질문이 종료돼요.</li>` +
      `<li>본 서비스는 자미두수 명반 해석만 제공하며, 의료·법률·재무·투자에 관한 조언은 <strong>제공하지 않아요</strong>.</li>` +
      `<li><strong>디지털 서비스이므로 제출 후에는 환불되지 않아요.</strong> 모든 답변은 회원님을 위해 개별로 작성되므로, 결제 후에는 환불해 드리지 않아요.</li>` +
      `</ul></div>`;
  }
  if (L.startsWith('zh')) {
