...
## 8. 三語注意
- 本 task 若動到文字，一併走 i18n（新增 key 進 i18n.js，三語，zh-TW/zh-CN 用詞正確區分）
- UI 語言可 header 即時切換；報告內容語言鎖 preferred_language（不受切換影響）
- 禁用戲劇隱喻詞（演/演法/角色/劇本/performed/play this role）
