...
//   1) 該頁 <head> 載入 i18n.js 後,呼叫 window.FSI18N.addUI({ 'page.key':{ 'zh-TW':…,'zh-CN':…,'en':…,'ja':… } })。
...
//   ‣ ja(2026-09 第四語言):UI/RT/STAR_NAMES/LIMIT_PREFIX 各加 ja;術語用日本新字体漢字
//     (化禄/化権/官禄宮/福徳宮…),介面文字為日語。RT 的「鍵」維持繁中原名(查表用),只有「值」是日語。
//   ‣ ko(2026-09 第五語言):UI/RT/STAR_NAMES/LIMIT_PREFIX 各加 ko;術語用 Ben 韓文術語清單(諺文,
//     명궁/부처궁/화록/녹존성…,不用漢字);starLabel 運限前綴後空一格(대한 천허);RT 鍵同樣維持繁中。
//     2026-09-26 韓文專家審定:介面 流月=월운、本命=선천、本命盤=선천 명반、單獨問事=1:1 맞춤 질문;
//     命盤內運限前綴 大限/流年/流月 = 대한/유년/유월(前綴後空一格);雜曜不加「성」(天月 천월 ≠ 天鉞 천월성)。
// ============================================================
(function () {
  'use strict';

  var SUPPORTED_LANGS   = ['zh-TW', 'zh-CN', 'en', 'ja', 'ko'];
  ...
  "ja": {
    ...
    "navMySpace": "マイスペース",
    "navOfficial": "公式サイト",
    "navSkipToMain": "メインコンテンツへスキップ",
    "backToTop": "ページの先頭へ",
    "footerTagline": "運命を予知するのではなく、<br>望む人生へ、意識して着実に歩んでいくために。",
    "footerPrivacy": "プライバシーポリシー",
    "footerDisclaimer": "免責事項",
    "footerContact": "お問い合わせ",
    "footerCopySuffix": "紫微斗数",
    "loadingSub": "本命十二宮を展開しています…",
    "hubTitle": "本命十二宮",
    "hubSub": "宮をタップすると、詳しい解説を読めます",
    "ovToHub": "十二宮をすべて見る →",
    "palaceSubtitle": "主星 · 輔星 · 四化",
    "sectionPalaceAnalysis": "宮の解説",
    "compHeavenlyStem": "天干",
    "compBranch": "地支",
    "compOpposite": "対宮",
    "compTrines": "三方",
    "emptyNoStar": "（星なし）",
    "emptyNoMainStar": "（主星なし）",
    "dirIn": "飛入",
    "dirOut": "飛出",
    "energyEmptyIn": "この宮に飛入するエネルギーはありません",
    "energyEmptyOut": "この宮から飛出するエネルギーはありません",
    "errJobFail": "命盤データを取得できませんでした：",
    "errNotReady": "命盤はまだ作成中です。数分後にもう一度ご確認ください。",
    "errNoPalace": "命盤の宮の内容が見つかりません。",
    "errLoad": "読み込み中にエラーが発生しました。",
    "errReportsFail": "宮の内容を読み込めませんでした：",
    "chipSourceLabel": "起点",
    "chipFlowLabel": "流れ先",
    "loadingTitle": "命盤を読み込んでいます",
    "palaceExplainerLabel": "この宮について",
    "compositionLabel": "構成",
    "secInflowTitle": "飛入エネルギー",
    "secOutflowTitle": "飛出エネルギー",
    "secSuggestTitle": "アドバイス",
    "sectionInflowDesc": "<strong>飛入するエネルギー</strong>——ほかの宮の星が、四化の形でこの宮に流れ込みます。あなたのこの領域が、人生のどの側面から<strong>育まれ、後押しされ、引き寄せられている</strong>かを表します。",
    "sectionOutflowDesc": "<strong>飛出するエネルギー</strong>——この宮のエネルギーが、四化の形でほかの宮へ流れ出します。あなたのこの領域が、人生のどの側面に<strong>影響を与え、貢献し、引き寄せている</strong>かを表します。",
    "errTitle": "命盤を読み込めません",
    "btnBackDashboard": "ダッシュボードに戻る",
    "ovEyebrow": "概要",
    "ovTitle": "あなたの命盤の概要",
    "blockSub1": "あなたは自分の物語の中で、どんな主人公なのか。",
    "blockHead2": "あなたの持ち札",
    "blockSub2": "手元にあるカード——生まれ持ったものと、ほかの人から得られるもの。",
    "secLeadLabel": "主人公",
    "secStageLabel": "人生の核",
    "secStageSub": "The Stage · 命三方",
    "secGiftLabel": "生まれ持った才能",
    "secGiftSub": "Innate Kit · 生年四化の位置",
    "secAllyLabel": "貴人",
    "secFeedLabel": "後ろ盾",
    "secFeedSub": "Foundation · 飛入の助力",
    "legendStage": "文は「【財】を舞台に、【命】に突き動かされ、【官】で展開する」の形で固定です。括弧内の語句は各宮の主星の定型語から取っています<span class=\"sp\">|</span>宮をタップすると詳しい解説へ",
    "legendAlly": "六内六外で分けています：貴人星が<span class=\"tg\">内側の宮</span>にある＝生まれ持った資質、<span class=\"tg\">外側の宮</span>にある＝ほかの人からの助力<span class=\"sp\">|</span><span class=\"tg\">左輔右弼</span> 統合・周囲の支え<span class=\"sp\">|</span><span class=\"tg\">天魁天鉞</span> 引き立て・気品<span class=\"sp\">|</span><span class=\"tg\">文昌</span> 学識<span class=\"sp\">|</span><span class=\"tg\">文曲</span> 才芸・話術",
    "legendFeed": "<span class=\"tg\">禄</span> 資源・縁<span class=\"sp\">|</span><span class=\"tg\">権</span> 主導・掌握<span class=\"sp\">|</span><span class=\"tg\">科</span> 名声・気品<span class=\"sp\">|</span>助力合計＝禄＋権＋科の飛入数（合計順）",
    "leadThemePrefix": "核心テーマ（生年四化が命宮に入る）：",
    "ovStarsLabel": "星：",
    "ovLeadFullLink": "{p}の詳しい解説 →",
    "leadLegendPrefix": "性格＝命宮の主星を定型の語彙で組み合わせたもの",
    "ovEmptyLife": "命宮は空宮 · 主星なし",
    "stageWealthClause": "「<b>{x}</b>」を舞台に",
    "stageLifeClause": "「<b>{x}</b>」に突き動かされ",
    "stageCareerClause": "「<b>{x}</b>」の中で展開する",
    "stageJoin": "、",
    "stageEnd": "。",
    "ovStageEmpty": "命三方に空宮が含まれるため、説明を省略します",
    "allySelfHeader": "生まれ持った資質 · 内側の宮（あなた自身に備わるもの）",
    "allyExtHeader": "外からの貴人 · 外側の宮（ほかの人が助けてくれるもの）",
    "allyEmpty": "この命盤に貴人星はありません",
    "feedLu": "禄",
    "feedQuan": "権",
    "feedKe": "科",
    "feedSumLabel": "助力",
    "feedEmpty": "飛入の助力はありません"
  },
  "ko": {
    "navDecade": "대한",
    "navConsultation": "1:1 맞춤 질문",
    "navComingSoon": "곧 공개",
    "navChart": "선천 명반",
    "navAnnual": "유년",
    "navMonthly": "월운",
    ...
    "navMySpace": "마이 스페이스",
    "navOfficial": "공식 사이트",
    "navSkipToMain": "본문으로 건너뛰기",
    "backToTop": "맨 위로",
    "footerTagline": "운명을 미리 아는 것이 아니라,<br>바라는 삶을 향해 의식적으로 한 걸음씩 나아가기 위해",
    "footerPrivacy": "개인정보 처리방침",
    "footerDisclaimer": "면책 고지",
    "footerContact": "문의하기",
    "footerCopySuffix": "자미두수",
    "loadingSub": "선천 12궁을 펼치고 있어요…",
    "hubTitle": "선천 12궁",
    "hubSub": "궁을 누르면 전체 해석을 볼 수 있어요",
    "ovToHub": "12궁 모두 보기 →",
    "palaceSubtitle": "주성 · 보성 · 사화",
    "sectionPalaceAnalysis": "궁 해석",
    "compHeavenlyStem": "천간",
    "compBranch": "지지",
    "compOpposite": "대궁",
    "compTrines": "삼방",
    ...
    "errLoad": "불러오는 중 오류가 발생했어요.",
    "errReportsFail": "궁 내용을 불러오지 못했어요: ",
    "chipSourceLabel": "출발",
    "chipFlowLabel": "도착",
    ...
    "ovEyebrow": "개요",
    "ovTitle": "나의 명반 개요",
    "blockSub1": "내 이야기 속에서 나는 어떤 주인공일까요?",
    "blockHead2": "나의 자원",
    "blockSub2": "내 손에 든 카드—타고난 것, 그리고 다른 사람이 건네줄 수 있는 것.",
    "secLeadLabel": "주인공",
    "secStageLabel": "삶의 중심",
    "secStageSub": "The Stage · 명궁 삼방",
    "secGiftLabel": "타고난 재능",
    "secGiftSub": "Innate Kit · 생년사화의 자리",
    "secAllyLabel": "귀인",
    "secFeedLabel": "든든한 뒷받침",
    "secFeedSub": "Foundation · 들어오는 도움",
    "legendStage": "문장은 「무대는 【재백궁】, 원동력은 【명궁】, 펼쳐지는 곳은 【관록궁】」 형식으로 고정되어 있으며, 괄호 안의 말은 각 궁 주성의 고정 어휘에서 가져와요<span class=\"sp\">|</span>궁을 누르면 전체 해석으로 이동해요",
    "legendAlly": "안쪽 여섯 궁과 바깥쪽 여섯 궁으로 나눠요: 귀인 별이 <span class=\"tg\">안쪽 궁</span>에 있으면 = 타고난 자질, <span class=\"tg\">바깥쪽 궁</span>에 있으면 = 다른 사람의 도움<span class=\"sp\">|</span><span class=\"tg\">좌보성 · 우필성</span> 통합 · 주변의 지지<span class=\"sp\">|</span><span class=\"tg\">천괴성 · 천월성</span> 이끌어 줌 · 품격<span class=\"sp\">|</span><span class=\"tg\">문창성</span> 학식<span class=\"sp\">|</span><span class=\"tg\">문곡성</span> 재능 · 말솜씨",
    "legendFeed": "<span class=\"tg\">화록</span> 자원 · 인연<span class=\"sp\">|</span><span class=\"tg\">화권</span> 주도 · 장악<span class=\"sp\">|</span><span class=\"tg\">화과</span> 명성 · 품격<span class=\"sp\">|</span>도움 합계 = 들어오는 화록 + 화권 + 화과의 수 (합계순 정렬)",
    "leadThemePrefix": "핵심 주제 (생년사화가 명궁에 있음): ",
    "ovStarsLabel": "성요: ",
    "ovLeadFullLink": "{p} 전체 해석 →",
    "leadLegendPrefix": "성격 = 명궁 주성을 고정 어휘로 조합한 것",
    "ovEmptyLife": "명궁이 공궁 · 주성 없음",
    "stageWealthClause": "무대는 「<b>{x}</b>」",
    "stageLifeClause": "원동력은 「<b>{x}</b>」",
    "stageCareerClause": "펼쳐지는 곳은 「<b>{x}</b>」",
    "stageJoin": ", ",
    "stageEnd": ".",
    "ovStageEmpty": "명궁 삼방에 공궁이 있어 설명을 생략해요",
    "allySelfHeader": "타고난 자질 · 안쪽 궁 (스스로 갖춘 것)",
    "allyExtHeader": "바깥 귀인 · 바깥쪽 궁 (다른 사람이 도와주는 것)",
    "allyEmpty": "이 명반에는 귀인 별이 없어요",
    "feedLu": "화록",
    "feedQuan": "화권",
    "feedKe": "화과",
    "feedSumLabel": "도움",
    "feedEmpty": "들어오는 도움이 없어요"
  }
};
  ...
  "zh-TW": {
    ...
    "PALACE_EXPLAINER_DECADE": {
      "命宮": "大限命宮代表您<span class=\"domain-keyword\">這個大限整體的基調、心境與行動姿態</span>——這段期間您看待自己與處境的主軸，所有其他宮位的大限能量，都會在這裡匯流。",
      "兄弟宮": "大限兄弟宮反映這個大限您與<span class=\"domain-keyword\">手足、同輩、密切夥伴</span>的互動與資源往來，以及團隊、同儕關係的流動。",
      "夫妻宮": "大限夫妻宮反映這個大限您的<span class=\"domain-keyword\">親密關係、伴侶互動與情感狀態</span>——這段期間感情的流向與課題。",
      "子女宮": "大限子女宮反映這個大限您的<span class=\"domain-keyword\">子女、後輩、創造力與作品</span>——這段期間您孕育、栽培之事的動向。",
      "財帛宮": "大限財帛宮反映這個大限您的<span class=\"domain-keyword\">財富、現金流與用錢態度</span>——這段期間金錢的進出與價值取捨。",
      "疾厄宮": "大限疾厄宮反映這個大限您的<span class=\"domain-keyword\">身體、健康與情緒狀態</span>——這段期間身心的感受與需要留意的節奏。",
      "遷移宮": "大限遷移宮反映這個大限您的<span class=\"domain-keyword\">外在際遇、機運與社會形象</span>——這段期間離開熟悉環境後的機會與人緣。",
      "交友宮": "大限交友宮反映這個大限您的<span class=\"domain-keyword\">朋友、人脈、下屬與社交網絡</span>——這段期間人際的助力與往來。",
      "官祿宮": "大限官祿宮反映這個大限您的<span class=\"domain-keyword\">事業、志向與表現舞台</span>——這段期間工作與成就的動向。",
      "田宅宮": "大限田宅宮反映這個大限您的<span class=\"domain-keyword\">家庭、不動產與安身之所</span>——這段期間居家、家族與根基的變化。",
      "福德宮": "大限福德宮反映這個大限您的<span class=\"domain-keyword\">精神世界、興趣與內在感受</span>——這段期間心靈的快樂來源與安頓。",
  ...
  "zh-CN": {
    ...
    "PALACE_EXPLAINER_DECADE": {
      "命宮": "大限命宫代表您<span class=\"domain-keyword\">这个大限整体的基调、心境与行动姿态</span>——这段期间您看待自己与处境的主轴，所有其他宫位的大限能量，都会在这里汇流。",
      "兄弟宮": "大限兄弟宫反映这个大限您与<span class=\"domain-keyword\">手足、同辈、密切伙伴</span>的互动与资源往来，以及团队、同侪关系的流动。",
      "夫妻宮": "大限夫妻宫反映这个大限您的<span class=\"domain-keyword\">亲密关系、伴侣互动与情感状态</span>——这段期间感情的流向与课题。",
      "子女宮": "大限子女宫反映这个大限您的<span class=\"domain-keyword\">子女、后辈、创造力与作品</span>——这段期间您孕育、栽培之事的动向。",
      "財帛宮": "大限财帛宫反映这个大限您的<span class=\"domain-keyword\">财富、现金流与用钱态度</span>——这段期间金钱的进出与价值取舍。",
      "疾厄宮": "大限疾厄宫反映这个大限您的<span class=\"domain-keyword\">身体、健康与情绪状态</span>——这段期间身心的感受与需要留意的节奏。",
      "遷移宮": "大限迁移宫反映这个大限您的<span class=\"domain-keyword\">外在际遇、机运与社会形象</span>——这段期间离开熟悉环境后的机会与人缘。",
      "交友宮": "大限交友宫反映这个大限您的<span class=\"domain-keyword\">朋友、人脉、下属与社交网络</span>——这段期间人际的助力与往来。",
      "官祿宮": "大限官禄宫反映这个大限您的<span class=\"domain-keyword\">事业、志向与表现舞台</span>——这段期间工作与成就的动向。",
      "田宅宮": "大限田宅宫反映这个大限您的<span class=\"domain-keyword\">家庭、不动产与安身之所</span>——这段期间居家、家族与根基的变化。",
      "福德宮": "大限福德宫反映这个大限您的<span class=\"domain-keyword\">精神世界、兴趣与内在感受</span>——这段期间心灵的快乐来源与安顿。",
  ...
  "ja": {
    ...
    "PALACE_EXPLAINER": {
      "命宮": "命宮は、あなたの<span class=\"domain-keyword\">核となる人格、行動スタイル、根本的な姿勢</span>を表します——自分自身と世界を捉える、もっとも根底にある見方です。ここは人生の「メインステージ」であり、ほかのすべての宮のエネルギーは最終的にここに集まり、あなたによって解釈され、表現されます。",
      "兄弟宮": "兄弟宮は、あなたと<span class=\"domain-keyword\">兄弟姉妹、同世代、母親、親しい仲間</span>との関係を表し、チームや同僚の中での付き合い方や、資源のやり取りも映し出します。",
      "夫妻宮": "夫妻宮は、あなたの<span class=\"domain-keyword\">親密な関係、パートナーとの関わり、感情のパターン</span>を表します——どのように愛し、愛されるのか、そして一対一の深い関係におけるあなたの姿勢です。",
      "子女宮": "子女宮は、あなたの<span class=\"domain-keyword\">子ども、後進、創造力、性</span>を表します——広く言えば、あなたが「生み出すもの」。作品、教え子、年下の人など、自ら育てるすべてを含みます。",
      "財帛宮": "財帛宮は、あなたの<span class=\"domain-keyword\">財、キャッシュフロー、価値観</span>を表します——お金をどう稼ぎ、どう使い、どう捉えるか、そして「持つこと」への姿勢です。",
      "疾厄宮": "疾厄宮は、あなたの<span class=\"domain-keyword\">身体、健康、感情面の体質</span>を表します——生まれ持った体質の傾向、心身の感じ方、そしてストレスが体にどう現れるかです。",
      "遷移宮": "遷移宮は、あなたの<span class=\"domain-keyword\">外の世界、巡り合わせ、社会的なイメージ</span>を表します——慣れた環境を離れたときの出会いや外での機運、そしてほかの人の目に映るあなたです。命宮の対宮であり、あなたのもう一つの面を映します。",
      "交友宮": "交友宮は、あなたの<span class=\"domain-keyword\">友人、人脈、部下、社交のネットワーク</span>を表します——幅広い人間関係との関わり方、そしてコミュニティから受け取り、また注ぐエネルギーです。",
      "官祿宮": "官禄宮は、あなたの<span class=\"domain-keyword\">仕事、志、社会的な達成</span>を表します——仕事の舞台、専門分野での表現、そして生涯をかけて築きたい功績と立ち位置です。",
      "田宅宮": "田宅宮は、あなたの<span class=\"domain-keyword\">家庭、不動産、身を落ち着ける場所</span>を表します——住まいの環境、家族の拠点、そして「帰属」や「根」に対する内なる感覚です。",
      "福德宮": "福徳宮は、あなたの<span class=\"domain-keyword\">精神世界、趣味、楽しみ</span>を表します——内なる喜びの源、価値観や信念、そして魂のレベルでの満足と安らぎです。",
      "父母宮": "父母宮は、あなたと<span class=\"domain-keyword\">両親、目上の人、権威、庇護</span>との関係を表し、学びの土台、上の立場の人との関わり、そして受け継いだ家の背景も映し出します。"
    },
    "PALACE_EXPLAINER_DECADE": {
      "命宮": "大限命宮は、<span class=\"domain-keyword\">この大限全体のトーン、心の状態、行動の姿勢</span>を表します——この時期、あなたが自分と状況を捉える軸であり、ほかのすべての宮の大限エネルギーがここに集まります。",
      "兄弟宮": "大限兄弟宮は、この大限のあなたと<span class=\"domain-keyword\">兄弟姉妹、同世代、親しい仲間</span>との関わりや資源のやり取り、そしてチームや同僚との関係の流れを映し出します。",
      "夫妻宮": "大限夫妻宮は、この大限のあなたの<span class=\"domain-keyword\">親密な関係、パートナーとの関わり、感情の状態</span>を映し出します——この時期の恋愛・感情の流れと課題です。",
      "子女宮": "大限子女宮は、この大限のあなたの<span class=\"domain-keyword\">子ども、後進、創造力、作品</span>を映し出します——この時期にあなたが生み出し、育てるものの動きです。",
      "財帛宮": "大限財帛宮は、この大限のあなたの<span class=\"domain-keyword\">財、キャッシュフロー、お金の使い方</span>を映し出します——この時期のお金の出入りと、価値の選び方です。",
      "疾厄宮": "大限疾厄宮は、この大限のあなたの<span class=\"domain-keyword\">身体、健康、感情の状態</span>を映し出します——この時期の心身の感覚と、気をつけたいリズムです。",
      "遷移宮": "大限遷移宮は、この大限のあなたの<span class=\"domain-keyword\">外での巡り合わせ、機運、社会的なイメージ</span>を映し出します——この時期に慣れた環境を離れたときのチャンスと、人との縁です。",
      "交友宮": "大限交友宮は、この大限のあなたの<span class=\"domain-keyword\">友人、人脈、部下、社交のネットワーク</span>を映し出します——この時期の人間関係からの助力とやり取りです。",
      "官祿宮": "大限官禄宮は、この大限のあなたの<span class=\"domain-keyword\">仕事、志、活躍の舞台</span>を映し出します——この時期の仕事と達成の動きです。",
      "田宅宮": "大限田宅宮は、この大限のあなたの<span class=\"domain-keyword\">家庭、不動産、身を落ち着ける場所</span>を映し出します——この時期の住まい、家族、基盤の変化です。",
      "福德宮": "大限福徳宮は、この大限のあなたの<span class=\"domain-keyword\">精神世界、趣味、内面の感覚</span>を映し出します——この時期の心の喜びの源と、安らぎです。",
      "父母宮": "大限父母宮は、この大限のあなたと<span class=\"domain-keyword\">両親、目上の人、権威、庇護</span>との関係、そして学びや上の立場の人との関わりを映し出します。"
    },
    "TRANSFORM_TOOLTIP_DECADE": {
      "化祿": {
        "title": "化禄 · Resource (Lu)",
        "body": "喜びと縁が増します。エネルギーが資源や人脈、流れに乗る感覚、達成の喜びをもたらし、この大限にスムーズに展開しやすい領域です。"
      },
      "化權": {
        "title": "化権 · Anchor (Quan)",
        "body": "権力と掌握。エネルギーが主導権、決断力、影響力を与え、この大限にあなたが「自分で決めたい」、物事に責任を持ちたいと感じる領域です。"
      },
      "化科": {
        "title": "化科 · Stage (Ke)",
        "body": "名声と注目。エネルギーによってこの領域で評価や認知、品のあるイメージを得やすくなり、この大限に輝き、称賛される舞台です。"
      },
      "化忌": {
        "title": "化忌 · Direction (Ji)",
        "body": "満たされなさとこだわり。エネルギーによって、この領域に何度も打ち込み、深く掘り下げていきます。これは欠点ではなく、この大限に特に意識を向け、心を注ぎたい方向です。"
      }
    },
    "PALACE_EXPLAINER_ANNUAL": {
      "命宮": "流年命宮は、<span class=\"domain-keyword\">今年全体のトーン、心の状態、行動の姿勢</span>を表します——この一年、あなたが自分と状況を捉える軸であり、ほかのすべての宮の流年エネルギーがここに集まります。",
      "兄弟宮": "流年兄弟宮は、今年のあなたと<span class=\"domain-keyword\">兄弟姉妹、同世代、親しい仲間</span>との関わりや資源のやり取り、そしてチームや同僚との関係の流れを映し出します。",
      "夫妻宮": "流年夫妻宮は、今年のあなたの<span class=\"domain-keyword\">親密な関係、パートナーとの関わり、感情の状態</span>を映し出します——この一年の恋愛・感情の流れと課題です。",
      "子女宮": "流年子女宮は、今年のあなたの<span class=\"domain-keyword\">子ども、後進、創造力、作品</span>を映し出します——この一年にあなたが生み出し、育てるものの動きです。",
      "財帛宮": "流年財帛宮は、今年のあなたの<span class=\"domain-keyword\">財、キャッシュフロー、お金の使い方</span>を映し出します——この一年のお金の出入りと、価値の選び方です。",
      "疾厄宮": "流年疾厄宮は、今年のあなたの<span class=\"domain-keyword\">身体、健康、感情の状態</span>を映し出します——この一年の心身の感覚と、気をつけたいリズムです。",
      "遷移宮": "流年遷移宮は、今年のあなたの<span class=\"domain-keyword\">外での巡り合わせ、機運、社会的なイメージ</span>を映し出します——この一年に慣れた環境を離れたときのチャンスと、人との縁です。",
      "交友宮": "流年交友宮は、今年のあなたの<span class=\"domain-keyword\">友人、人脈、部下、社交のネットワーク</span>を映し出します——この一年の人間関係からの助力とやり取りです。",
      "官祿宮": "流年官禄宮は、今年のあなたの<span class=\"domain-keyword\">仕事、志、活躍の舞台</span>を映し出します——この一年の仕事と達成の動きです。",
      "田宅宮": "流年田宅宮は、今年のあなたの<span class=\"domain-keyword\">家庭、不動産、身を落ち着ける場所</span>を映し出します——この一年の住まい、家族、基盤の変化です。",
      "福德宮": "流年福徳宮は、今年のあなたの<span class=\"domain-keyword\">精神世界、趣味、内面の感覚</span>を映し出します——この一年の心の喜びの源と、安らぎです。",
      "父母宮": "流年父母宮は、今年のあなたと<span class=\"domain-keyword\">両親、目上の人、権威、庇護</span>との関係、そして学びや上の立場の人との関わりを映し出します。"
    },
    "TRANSFORM_TOOLTIP_ANNUAL": {
      "化祿": {
        "title": "化禄 · Resource (Lu)",
        "body": "喜びと縁が増します。エネルギーが資源や人脈、流れに乗る感覚、達成の喜びをもたらし、今年スムーズに展開しやすい領域です。"
      },
      "化權": {
        "title": "化権 · Anchor (Quan)",
        "body": "権力と掌握。エネルギーが主導権、決断力、影響力を与え、今年あなたが「自分で決めたい」、物事に責任を持ちたいと感じる領域です。"
      },
      "化科": {
        "title": "化科 · Stage (Ke)",
        "body": "名声と注目。エネルギーによってこの領域で評価や認知、品のあるイメージを得やすくなり、今年輝き、称賛される舞台です。"
      },
      "化忌": {
        "title": "化忌 · Direction (Ji)",
        "body": "満たされなさとこだわり。エネルギーによって、この領域に何度も打ち込み、深く掘り下げていきます。これは欠点ではなく、今年特に意識を向け、心を注ぎたい方向です。"
      }
    },
    "PALACE_EXPLAINER_MONTHLY": {
      "命宮": "流月命宮は、<span class=\"domain-keyword\">今月全体のトーン、心の状態、行動の姿勢</span>を表します——この一か月、あなたが自分と状況を捉える軸であり、ほかのすべての宮の流月エネルギーがここに集まります。",
      "兄弟宮": "流月兄弟宮は、今月のあなたと<span class=\"domain-keyword\">兄弟姉妹、同世代、親しい仲間</span>との関わりや資源のやり取り、そしてチームや同僚との関係の流れを映し出します。",
      "夫妻宮": "流月夫妻宮は、今月のあなたの<span class=\"domain-keyword\">親密な関係、パートナーとの関わり、感情の状態</span>を映し出します——この一か月の恋愛・感情の流れと課題です。",
      "子女宮": "流月子女宮は、今月のあなたの<span class=\"domain-keyword\">子ども、後進、創造力、作品</span>を映し出します——この一か月にあなたが生み出し、育てるものの動きです。",
      "財帛宮": "流月財帛宮は、今月のあなたの<span class=\"domain-keyword\">財、キャッシュフロー、お金の使い方</span>を映し出します——この一か月のお金の出入りと、価値の選び方です。",
      "疾厄宮": "流月疾厄宮は、今月のあなたの<span class=\"domain-keyword\">身体、健康、感情の状態</span>を映し出します——この一か月の心身の感覚と、気をつけたいリズムです。",
      "遷移宮": "流月遷移宮は、今月のあなたの<span class=\"domain-keyword\">外での巡り合わせ、機運、社会的なイメージ</span>を映し出します——この一か月に慣れた環境を離れたときのチャンスと、人との縁です。",
      "交友宮": "流月交友宮は、今月のあなたの<span class=\"domain-keyword\">友人、人脈、部下、社交のネットワーク</span>を映し出します——この一か月の人間関係からの助力とやり取りです。",
      "官祿宮": "流月官禄宮は、今月のあなたの<span class=\"domain-keyword\">仕事、志、活躍の舞台</span>を映し出します——この一か月の仕事と達成の動きです。",
      "田宅宮": "流月田宅宮は、今月のあなたの<span class=\"domain-keyword\">家庭、不動産、身を落ち着ける場所</span>を映し出します——この一か月の住まい、家族、基盤の変化です。",
      "福德宮": "流月福徳宮は、今月のあなたの<span class=\"domain-keyword\">精神世界、趣味、内面の感覚</span>を映し出します——この一か月の心の喜びの源と、安らぎです。",
      "父母宮": "流月父母宮は、今月のあなたと<span class=\"domain-keyword\">両親、目上の人、権威、庇護</span>との関係、そして学びや上の立場の人との関わりを映し出します。"
    },
    "TRANSFORM_TOOLTIP_MONTHLY": {
      "化祿": {
        "title": "化禄 · Resource (Lu)",
        "body": "喜びと縁が増します。エネルギーが資源や人脈、流れに乗る感覚、達成の喜びをもたらし、今月スムーズに展開しやすい領域です。"
      },
      "化權": {
        "title": "化権 · Anchor (Quan)",
        "body": "権力と掌握。エネルギーが主導権、決断力、影響力を与え、今月あなたが「自分で決めたい」、物事に責任を持ちたいと感じる領域です。"
      },
      "化科": {
        "title": "化科 · Stage (Ke)",
        "body": "名声と注目。エネルギーによってこの領域で評価や認知、品のあるイメージを得やすくなり、今月輝き、称賛される舞台です。"
      },
      "化忌": {
        "title": "化忌 · Direction (Ji)",
        "body": "満たされなさとこだわり。エネルギーによって、この領域に何度も打ち込み、深く掘り下げていきます。これは欠点ではなく、今月特に意識を向け、心を注ぎたい方向です。"
      }
    },
    "TRANSFORM_TOOLTIP": {
      "化祿": {
        "title": "化禄 · Resource (Lu)",
        "body": "喜びと縁が増します。エネルギーが資源や人脈、流れに乗る感覚、達成の喜びをもたらし、あなたが生まれつき恵まれ、スムーズに展開しやすい領域です。"
      },
      "化權": {
        "title": "化権 · Anchor (Quan)",
        "body": "権力と掌握。エネルギーがあなたに主導権、決断力、影響力を与え、生まれつき「自分で決めたい」、物事に責任を持ちたいと感じる領域です。"
      },
      "化科": {
        "title": "化科 · Stage (Ke)",
        "body": "名声と注目。エネルギーによってこの領域で評価や認知、品のあるイメージを得やすくなり、あなたが生まれつき輝き、称賛される舞台です。"
      },
      "化忌": {
        "title": "化忌 · Direction (Ji)",
        "body": "満たされなさとこだわり。エネルギーによって、この領域に何度も打ち込み、深く掘り下げ、決して満ち足りることがありません。これは欠点ではなく、あなたが生涯向き合う「核心テーマ」であり、成長の方向です。"
      }
    },
    "SAN_FANG_ROLE": {
      "命宮": "自己",
    ...
    "SELF_TRANSFORM_NOTE": {
      "化祿": "生まれ持った流れの良さと福分が「自己」に表れます。",
      "化權": "生まれ持った主導性が「自己」に宿ります。",
      "化科": "生まれ持った名声と気品が「自己」に宿ります。",
      "化忌": "「もっと欲しい、もっと体験したい」という思いを深く掘り下げる——自己の核心テーマであり、生涯くり返し力を注ぐ方向です。"
    },
    "BIRTH_MEANING": {
      "化祿": "生まれ持った福分の位置",
      "化權": "生まれ持った掌握と課題",
  ...
  "ko": {
    ...
    "PALACE_EXPLAINER": {
      "命宮": "명궁은 <span class=\"domain-keyword\">핵심 성격, 행동 방식, 근본적인 태도</span>를 나타내요 — 자신과 세상을 바라보는 가장 깊은 바탕이에요. 명궁은 삶의 ‘중심 무대’로, 다른 모든 궁의 에너지가 결국 이곳으로 모여 나만의 방식으로 해석되고 표현돼요.",
      "兄弟宮": "형제궁은 <span class=\"domain-keyword\">형제자매, 동년배, 어머니, 가까운 동료</span>와의 관계를 나타내며, 팀이나 동료 사이에서 어울리는 방식과 자원을 주고받는 모습도 보여 줘요.",
      "夫妻宮": "부처궁은 <span class=\"domain-keyword\">친밀한 관계, 파트너와의 상호작용, 감정 패턴</span>을 나타내요 — 어떻게 사랑하고 사랑받는지, 그리고 일대일의 깊은 관계에서 어떤 태도를 보이는지를 담고 있어요.",
      "子女宮": "자녀궁은 <span class=\"domain-keyword\">자녀, 후배, 창조력, 섹슈얼리티</span>를 나타내요 — 넓게 보면 ‘길러 내는 모든 것’으로, 작품, 학생, 손아랫사람 등 직접 가꾸어 가는 모든 것을 포함해요.",
      "財帛宮": "재백궁은 <span class=\"domain-keyword\">재물, 현금 흐름, 가치관</span>을 나타내요 — 돈을 어떻게 벌고 쓰고 바라보는지, 그리고 ‘소유’를 대하는 태도를 담고 있어요.",
      "疾厄宮": "질액궁은 <span class=\"domain-keyword\">몸, 건강, 정서적 체질</span>을 나타내요 — 타고난 체질의 경향, 몸과 마음이 느끼는 방식, 그리고 스트레스가 몸에 드러나는 모습을 담고 있어요.",
      "遷移宮": "천이궁은 <span class=\"domain-keyword\">바깥세상, 만남의 인연, 사회적 이미지</span>를 나타내요 — 익숙한 환경을 떠났을 때의 만남과 바깥에서의 기회, 그리고 다른 사람의 눈에 비친 모습이에요. 명궁의 대궁으로서 또 다른 면을 비춰 줘요.",
      "交友宮": "교우궁은 <span class=\"domain-keyword\">친구, 인맥, 부하 직원, 사회적 네트워크</span>를 나타내요 — 폭넓은 인간관계 속에서 어울리는 방식, 그리고 공동체에서 받고 또 나누는 에너지를 담고 있어요.",
      "官祿宮": "관록궁은 <span class=\"domain-keyword\">일, 지향, 사회적 성취</span>를 나타내요 — 일의 무대와 전문 분야에서의 역량, 그리고 평생에 걸쳐 이루고 싶은 성과와 자리를 담고 있어요.",
      "田宅宮": "전택궁은 <span class=\"domain-keyword\">가정, 부동산, 마음 놓고 머무는 곳</span>을 나타내요 — 주거 환경과 가족의 터전, 그리고 ‘소속감’과 ‘뿌리’에 대한 내면의 감각을 담고 있어요.",
      "福德宮": "복덕궁은 <span class=\"domain-keyword\">정신세계, 취미, 즐거움</span>을 나타내요 — 내면의 기쁨이 샘솟는 곳, 가치와 신념, 그리고 영혼 깊은 곳에서의 만족과 평안을 담고 있어요.",
      "父母宮": "부모궁은 <span class=\"domain-keyword\">부모, 윗사람, 권위, 보살핌</span>과의 관계를 나타내며, 배움의 바탕과 윗자리에 있는 사람과 지내는 방식, 그리고 이어받은 집안 배경도 보여 줘요."
    },
    "PALACE_EXPLAINER_DECADE": {
      "命宮": "대한 명궁은 <span class=\"domain-keyword\">이번 대한 전체의 기조, 마음가짐, 행동 태도</span>를 나타내요 — 이 시기에 자신과 상황을 바라보는 중심축이며, 다른 모든 궁의 대한 에너지가 이곳으로 모여요.",
      "兄弟宮": "대한 형제궁은 이번 대한 동안 <span class=\"domain-keyword\">형제자매, 동년배, 가까운 동료</span>와 어떻게 교류하고 자원을 주고받는지, 그리고 팀과 동료 관계가 어떻게 흘러가는지를 보여 줘요.",
      "夫妻宮": "대한 부처궁은 이번 대한의 <span class=\"domain-keyword\">친밀한 관계, 파트너와의 상호작용, 감정 상태</span>를 보여 줘요 — 이 시기의 감정 흐름과 과제예요.",
      "子女宮": "대한 자녀궁은 이번 대한의 <span class=\"domain-keyword\">자녀, 후배, 창조력, 작품</span>을 보여 줘요 — 이 시기의 길러 내고 가꾸는 일들의 흐름이에요.",
      "財帛宮": "대한 재백궁은 이번 대한의 <span class=\"domain-keyword\">재물, 현금 흐름, 돈을 쓰는 태도</span>를 보여 줘요 — 이 시기의 돈이 들고 나는 흐름과 가치의 우선순위예요.",
      "疾厄宮": "대한 질액궁은 이번 대한의 <span class=\"domain-keyword\">몸, 건강, 정서 상태</span>를 보여 줘요 — 이 시기의 몸과 마음의 느낌, 그리고 살펴야 할 리듬이에요.",
      "遷移宮": "대한 천이궁은 이번 대한의 <span class=\"domain-keyword\">바깥의 인연, 기회의 흐름, 사회적 이미지</span>를 보여 줘요 — 이 시기에 익숙한 환경을 벗어났을 때 만나는 기회와 인연이에요.",
      "交友宮": "대한 교우궁은 이번 대한의 <span class=\"domain-keyword\">친구, 인맥, 부하 직원, 사회적 네트워크</span>를 보여 줘요 — 이 시기의 인간관계에서 얻는 도움과 교류예요.",
      "官祿宮": "대한 관록궁은 이번 대한의 <span class=\"domain-keyword\">일, 지향, 활약의 무대</span>를 보여 줘요 — 이 시기의 일과 성취의 흐름이에요.",
      "田宅宮": "대한 전택궁은 이번 대한의 <span class=\"domain-keyword\">가정, 부동산, 마음 놓고 머무는 곳</span>을 보여 줘요 — 이 시기에 집과 가족, 삶의 기반에 일어나는 변화예요.",
      "福德宮": "대한 복덕궁은 이번 대한의 <span class=\"domain-keyword\">정신세계, 취미, 내면의 느낌</span>을 보여 줘요 — 이 시기의 기쁨의 원천과 마음의 평안이에요.",
      "父母宮": "대한 부모궁은 이번 대한 동안 <span class=\"domain-keyword\">부모, 윗사람, 권위, 보살핌</span>과의 관계, 그리고 배움과 윗자리에 있는 사람과의 교류를 보여 줘요."
    },
    "TRANSFORM_TOOLTIP_DECADE": {
      "化祿": {
        "title": "화록 · 자원",
        "body": "기쁨과 인연이 늘어나요. 에너지가 자원과 인맥, 흐름을 타는 느낌, 성취의 기쁨을 가져다주며, 이번 대한에 순조롭게 펼쳐지기 쉬운 영역이에요."
      },
      "化權": {
        "title": "화권 · 중심",
        "body": "힘과 주도. 에너지가 주도하는 감각, 결단력, 영향력을 더해 주며, 이번 대한에 ‘내가 정하겠다’는 마음이 들고 스스로 책임지고 싶어지는 영역이에요."
      },
      "化科": {
        "title": "화과 · 무대",
        "body": "명성과 드러남. 에너지 덕분에 이 영역에서 평판과 인정, 품격 있는 이미지를 얻기 쉬우며, 이번 대한에 빛나고 인정받는 무대예요."
      },
      "化忌": {
        "title": "화기 · 방향",
        "body": "채워지지 않는 마음과 몰두. 에너지가 이 영역에 거듭 마음을 쏟고 깊이 파고들게 해요. 이는 결함이 아니라, 이번 대한에 특히 관심과 정성을 기울일 방향이에요."
      }
    },
    "PALACE_EXPLAINER_ANNUAL": {
      "命宮": "유년 명궁은 <span class=\"domain-keyword\">올해 전체의 기조, 마음가짐, 행동 태도</span>를 나타내요 — 올 한 해 자신과 상황을 바라보는 중심축이며, 다른 모든 궁의 유년 에너지가 이곳으로 모여요.",
      "兄弟宮": "유년 형제궁은 올해 <span class=\"domain-keyword\">형제자매, 동년배, 가까운 동료</span>와 어떻게 교류하고 자원을 주고받는지, 그리고 팀과 동료 관계가 어떻게 흘러가는지를 보여 줘요.",
      "夫妻宮": "유년 부처궁은 올해의 <span class=\"domain-keyword\">친밀한 관계, 파트너와의 상호작용, 감정 상태</span>를 보여 줘요 — 올 한 해의 감정 흐름과 과제예요.",
      "子女宮": "유년 자녀궁은 올해의 <span class=\"domain-keyword\">자녀, 후배, 창조력, 작품</span>을 보여 줘요 — 올 한 해의 길러 내고 가꾸는 일들의 흐름이에요.",
      "財帛宮": "유년 재백궁은 올해의 <span class=\"domain-keyword\">재물, 현금 흐름, 돈을 쓰는 태도</span>를 보여 줘요 — 올 한 해의 돈이 들고 나는 흐름과 가치의 우선순위예요.",
      "疾厄宮": "유년 질액궁은 올해의 <span class=\"domain-keyword\">몸, 건강, 정서 상태</span>를 보여 줘요 — 올 한 해의 몸과 마음의 느낌, 그리고 살펴야 할 리듬이에요.",
      "遷移宮": "유년 천이궁은 올해의 <span class=\"domain-keyword\">바깥의 인연, 기회의 흐름, 사회적 이미지</span>를 보여 줘요 — 올 한 해 익숙한 환경을 벗어났을 때 만나는 기회와 인연이에요.",
      "交友宮": "유년 교우궁은 올해의 <span class=\"domain-keyword\">친구, 인맥, 부하 직원, 사회적 네트워크</span>를 보여 줘요 — 올 한 해의 인간관계에서 얻는 도움과 교류예요.",
      "官祿宮": "유년 관록궁은 올해의 <span class=\"domain-keyword\">일, 지향, 활약의 무대</span>를 보여 줘요 — 올 한 해의 일과 성취의 흐름이에요.",
      "田宅宮": "유년 전택궁은 올해의 <span class=\"domain-keyword\">가정, 부동산, 마음 놓고 머무는 곳</span>을 보여 줘요 — 올 한 해 집과 가족, 삶의 기반에 일어나는 변화예요.",
      "福德宮": "유년 복덕궁은 올해의 <span class=\"domain-keyword\">정신세계, 취미, 내면의 느낌</span>을 보여 줘요 — 올 한 해의 기쁨의 원천과 마음의 평안이에요.",
      "父母宮": "유년 부모궁은 올해 <span class=\"domain-keyword\">부모, 윗사람, 권위, 보살핌</span>과의 관계, 그리고 배움과 윗자리에 있는 사람과의 교류를 보여 줘요."
    },
    "TRANSFORM_TOOLTIP_ANNUAL": {
      "化祿": {
        "title": "화록 · 자원",
        "body": "기쁨과 인연이 늘어나요. 에너지가 자원과 인맥, 흐름을 타는 느낌, 성취의 기쁨을 가져다주며, 올해 순조롭게 펼쳐지기 쉬운 영역이에요."
      },
      "化權": {
        "title": "화권 · 중심",
        "body": "힘과 주도. 에너지가 주도하는 감각, 결단력, 영향력을 더해 주며, 올해 ‘내가 정하겠다’는 마음이 들고 스스로 책임지고 싶어지는 영역이에요."
      },
      "化科": {
        "title": "화과 · 무대",
        "body": "명성과 드러남. 에너지 덕분에 이 영역에서 평판과 인정, 품격 있는 이미지를 얻기 쉬우며, 올해 빛나고 인정받는 무대예요."
      },
      "化忌": {
        "title": "화기 · 방향",
        "body": "채워지지 않는 마음과 몰두. 에너지가 이 영역에 거듭 마음을 쏟고 깊이 파고들게 해요. 이는 결함이 아니라, 올해 특히 관심과 정성을 기울일 방향이에요."
      }
    },
    "PALACE_EXPLAINER_MONTHLY": {
      "命宮": "월운 명궁은 <span class=\"domain-keyword\">이번 달 전체의 기조, 마음가짐, 행동 태도</span>를 나타내요 — 이번 달 자신과 상황을 바라보는 중심축이며, 다른 모든 궁의 월운 에너지가 이곳으로 모여요.",
      "兄弟宮": "월운 형제궁은 이번 달 <span class=\"domain-keyword\">형제자매, 동년배, 가까운 동료</span>와 어떻게 교류하고 자원을 주고받는지, 그리고 팀과 동료 관계가 어떻게 흘러가는지를 보여 줘요.",
      "夫妻宮": "월운 부처궁은 이번 달의 <span class=\"domain-keyword\">친밀한 관계, 파트너와의 상호작용, 감정 상태</span>를 보여 줘요 — 이번 달의 감정 흐름과 과제예요.",
      "子女宮": "월운 자녀궁은 이번 달의 <span class=\"domain-keyword\">자녀, 후배, 창조력, 작품</span>을 보여 줘요 — 이번 달의 길러 내고 가꾸는 일들의 흐름이에요.",
      "財帛宮": "월운 재백궁은 이번 달의 <span class=\"domain-keyword\">재물, 현금 흐름, 돈을 쓰는 태도</span>를 보여 줘요 — 이번 달의 돈이 들고 나는 흐름과 가치의 우선순위예요.",
      "疾厄宮": "월운 질액궁은 이번 달의 <span class=\"domain-keyword\">몸, 건강, 정서 상태</span>를 보여 줘요 — 이번 달의 몸과 마음의 느낌, 그리고 살펴야 할 리듬이에요.",
      "遷移宮": "월운 천이궁은 이번 달의 <span class=\"domain-keyword\">바깥의 인연, 기회의 흐름, 사회적 이미지</span>를 보여 줘요 — 이번 달 익숙한 환경을 벗어났을 때 만나는 기회와 인연이에요.",
      "交友宮": "월운 교우궁은 이번 달의 <span class=\"domain-keyword\">친구, 인맥, 부하 직원, 사회적 네트워크</span>를 보여 줘요 — 이번 달의 인간관계에서 얻는 도움과 교류예요.",
      "官祿宮": "월운 관록궁은 이번 달의 <span class=\"domain-keyword\">일, 지향, 활약의 무대</span>를 보여 줘요 — 이번 달의 일과 성취의 흐름이에요.",
      "田宅宮": "월운 전택궁은 이번 달의 <span class=\"domain-keyword\">가정, 부동산, 마음 놓고 머무는 곳</span>을 보여 줘요 — 이번 달 집과 가족, 삶의 기반에 일어나는 변화예요.",
      "福德宮": "월운 복덕궁은 이번 달의 <span class=\"domain-keyword\">정신세계, 취미, 내면의 느낌</span>을 보여 줘요 — 이번 달의 기쁨의 원천과 마음의 평안이에요.",
      "父母宮": "월운 부모궁은 이번 달 <span class=\"domain-keyword\">부모, 윗사람, 권위, 보살핌</span>과의 관계, 그리고 배움과 윗자리에 있는 사람과의 교류를 보여 줘요."
    },
    "TRANSFORM_TOOLTIP_MONTHLY": {
      "化祿": {
        "title": "화록 · 자원",
        "body": "기쁨과 인연이 늘어나요. 에너지가 자원과 인맥, 흐름을 타는 느낌, 성취의 기쁨을 가져다주며, 이번 달에 순조롭게 펼쳐지기 쉬운 영역이에요."
      },
      "化權": {
        "title": "화권 · 중심",
        "body": "힘과 주도. 에너지가 주도하는 감각, 결단력, 영향력을 더해 주며, 이번 달에 ‘내가 정하겠다’는 마음이 들고 스스로 책임지고 싶어지는 영역이에요."
      },
      "化科": {
        "title": "화과 · 무대",
        "body": "명성과 드러남. 에너지 덕분에 이 영역에서 평판과 인정, 품격 있는 이미지를 얻기 쉬우며, 이번 달에 빛나고 인정받는 무대예요."
      },
      "化忌": {
        "title": "화기 · 방향",
        "body": "채워지지 않는 마음과 몰두. 에너지가 이 영역에 거듭 마음을 쏟고 깊이 파고들게 해요. 이는 결함이 아니라, 이번 달에 특히 관심과 정성을 기울일 방향이에요."
      }
    },
    "TRANSFORM_TOOLTIP": {
      "化祿": {
        "title": "화록 · 자원",
        "body": "기쁨과 인연이 늘어나요. 에너지가 자원과 인맥, 흐름을 타는 느낌, 성취의 기쁨을 가져다주며, 본래 복이 깃들어 순조롭게 펼쳐지기 쉬운 영역이에요."
      },
      "化權": {
        "title": "화권 · 중심",
        "body": "힘과 주도. 에너지가 주도하는 감각, 결단력, 영향력을 더해 주며, 본래부터 ‘내가 정하겠다’는 마음이 들고 스스로 책임지고 싶어지는 영역이에요."
      },
      "化科": {
        "title": "화과 · 무대",
        "body": "명성과 드러남. 에너지 덕분에 이 영역에서 평판과 인정, 품격 있는 이미지를 얻기 쉬우며, 본래 빛을 발하고 인정받는 무대예요."
      },
      "化忌": {
        "title": "화기 · 방향",
        "body": "채워지지 않는 마음과 몰두. 에너지가 이 영역에 거듭 마음을 쏟고 깊이 파고들게 하며, 좀처럼 만족하지 않게 해요. 이는 결함이 아니라 평생 마주하는 ‘핵심 과제’이자 성장의 방향이에요."
      }
    },
    "SAN_FANG_ROLE": {
      "命宮": "자아",
    ...
    "ALLY_LEXICON": {
      "左輔": {
        "self": "자원을 아우르고 두루 도움을 얻는 힘",
        "ext": "곁에서 함께 돕는 동년배 귀인"
      },
      "右弼": {
        "self": "자원을 아우르고 두루 도움을 얻는 힘",
        "ext": "곁에서 함께 돕는 동년배 귀인"
      ...
      "天鉞": {
        "self": "눈에 띄고 이끌어 주는 사람을 만나기 쉬운 분위기",
        "ext": "윗사람 귀인의 후원"
      },
      "文昌": {
        "self": "학식과 체계",
    ...
    "SELF_TRANSFORM_NOTE": {
      "化祿": "타고난 순조로움과 복이 ‘자아’에서 드러나요.",
      "化權": "타고난 주도성이 ‘자아’에 자리해요.",
      "化科": "타고난 명성과 품격이 ‘자아’에 자리해요.",
      "化忌": "‘더 원하고, 더 경험하고 싶은’ 마음을 깊이 파고들어요 — 자아의 핵심 과제이자, 평생 거듭 마음을 쏟는 방향이에요."
    },
    "BIRTH_MEANING": {
      "化祿": "타고난 복이 머무는 곳",
      "化權": "타고난 주도권과 과제",
  ...
  var STAR_NAMES = {
    ...
    'ja': {   // 日本新字体漢字
      '截空':'截空','華蓋':'華蓋','天刑':'天刑','天巫':'天巫','天廚':'天厨',
      '孤辰':'孤辰','蜚廉':'蜚廉','三台':'三台','台輔':'台輔','解神':'解神',
      '天哭':'天哭','陰煞':'陰煞','寡宿':'寡宿','咸池':'咸池','天官':'天官',
      '封誥':'封誥','天福':'天福','破碎':'破砕','八座':'八座','天姚':'天姚',
      '天虛':'天虚','天月':'天月'
    },
    'ko': {   // 한자음,不加「성」(專家審定;天月 천월 與輔星 天鉞 천월성 以「성」區分)
      '截空':'절공','華蓋':'화개','天刑':'천형','天巫':'천무','天廚':'천주',
      '孤辰':'고진','蜚廉':'비렴','三台':'삼태','台輔':'태보','解神':'해신',
      '天哭':'천곡','陰煞':'음살','寡宿':'과숙','咸池':'함지','天官':'천관',
      '封誥':'봉고','天福':'천복','破碎':'파쇄','八座':'팔좌','天姚':'천요',
      '天虛':'천허','天月':'천월'
    }
  };
  ...
  var LIMIT_PREFIX = {
    ...
    'ja':    { '大限':'大限', '流年':'流年', '流月':'流月' },
    'ko':    { '大限':'대한', '流年':'유년', '流月':'유월' }
  };
  ...
  function starLabel(zh) {
    ...
    for (var i = 0; i < LIMIT_PREFIX_ORDER.length; i++) {
      ...
      if (zh.indexOf(p) === 0 && zh.length > p.length) {
        ...
        return (_reportLang === 'en' || _reportLang === 'ko') ? (pl + ' ' + base) : (pl + base);   // en/ko 前綴後空一格(대한 천허)
      }
    }
    return zh;
  }
  ...
  // ── 各頁專屬 UI 字典併入(策略 B)────────────────────────────
  //   dict = { 'page.key': { 'zh-TW':…, 'zh-CN':…, 'en':…, 'ja':… }, … }
