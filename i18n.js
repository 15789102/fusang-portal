...
//     暫定詞(待確認後批次替換):流月 유월、本命 본명、三方 삼방、空宮 공궁、天干/地支 천간/지지、雜曜 22 顆 한자음。
// ============================================================
(function () {
  'use strict';
  ...
  "ko": {
    ...
    "PALACE_EXPLAINER_MONTHLY": {
      "命宮": "유월 명궁은 <span class=\"domain-keyword\">이번 달 전체의 기조, 마음가짐, 행동 태도</span>를 나타내요 — 이번 달 자신과 상황을 바라보는 중심축이며, 다른 모든 궁의 유월 에너지가 이곳으로 모여요.",
      "兄弟宮": "유월 형제궁은 이번 달 <span class=\"domain-keyword\">형제자매, 동년배, 가까운 동료</span>와 어떻게 교류하고 자원을 주고받는지, 그리고 팀과 동료 관계가 어떻게 흘러가는지를 보여 줘요.",
      "夫妻宮": "유월 부처궁은 이번 달의 <span class=\"domain-keyword\">친밀한 관계, 파트너와의 상호작용, 감정 상태</span>를 보여 줘요 — 이번 달의 감정 흐름과 과제예요.",
      "子女宮": "유월 자녀궁은 이번 달의 <span class=\"domain-keyword\">자녀, 후배, 창조력, 작품</span>을 보여 줘요 — 이번 달의 길러 내고 가꾸는 일들의 흐름이에요.",
      "財帛宮": "유월 재백궁은 이번 달의 <span class=\"domain-keyword\">재물, 현금 흐름, 돈을 쓰는 태도</span>를 보여 줘요 — 이번 달의 돈이 들고 나는 흐름과 가치의 우선순위예요.",
      "疾厄宮": "유월 질액궁은 이번 달의 <span class=\"domain-keyword\">몸, 건강, 정서 상태</span>를 보여 줘요 — 이번 달의 몸과 마음의 느낌, 그리고 살펴야 할 리듬이에요.",
      "遷移宮": "유월 천이궁은 이번 달의 <span class=\"domain-keyword\">바깥의 인연, 기회의 흐름, 사회적 이미지</span>를 보여 줘요 — 이번 달 익숙한 환경을 벗어났을 때 만나는 기회와 인연이에요.",
      "交友宮": "유월 교우궁은 이번 달의 <span class=\"domain-keyword\">친구, 인맥, 부하 직원, 사회적 네트워크</span>를 보여 줘요 — 이번 달의 인간관계에서 얻는 도움과 교류예요.",
      "官祿宮": "유월 관록궁은 이번 달의 <span class=\"domain-keyword\">일, 지향, 활약의 무대</span>를 보여 줘요 — 이번 달의 일과 성취의 흐름이에요.",
      "田宅宮": "유월 전택궁은 이번 달의 <span class=\"domain-keyword\">가정, 부동산, 마음 놓고 머무는 곳</span>을 보여 줘요 — 이번 달 집과 가족, 삶의 기반에 일어나는 변화예요.",
      "福德宮": "유월 복덕궁은 이번 달의 <span class=\"domain-keyword\">정신세계, 취미, 내면의 느낌</span>을 보여 줘요 — 이번 달의 기쁨의 원천과 마음의 평안이에요.",
      "父母宮": "유월 부모궁은 이번 달 <span class=\"domain-keyword\">부모, 윗사람, 권위, 보살핌</span>과의 관계, 그리고 배움과 윗자리에 있는 사람과의 교류를 보여 줘요."
    },
    "TRANSFORM_TOOLTIP_MONTHLY": {
      "化祿": {
        "title": "화록 · 자원",
